...
BuildRequires: python%{pyver}-flake8-import-order >= 0.18-12.1
...
#BuildRequires: python-doc8
BuildRequires: python%{pyver}-oslotest >= 3.2.0
BuildRequires: python%{pyver}-os-testr >= 1.0.0
%if 0%{?fedora} || 0%{?rhel} > 7
BuildRequires: python3-pylint >= 2.4.3-1.1
%else
BuildRequires: python2-pylint >= 1.9.5-1.1
%endif

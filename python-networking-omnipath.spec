...
BuildRequires:  SQLAlchemy >= 1.2.0 # MIT
BuildRequires:  neutron-lib >= 1.25.0 # Apache-2.0
BuildRequires:  oslo.config >= 5.2.0 # Apache-2.0
BuildRequires:  paramiko >= 2.4.2 # GPLv2
BuildRequires:  six >= 1.10.0 # MIT
BuildRequires:  neutron >= 13.0.0.0b2 # Apache-2.0

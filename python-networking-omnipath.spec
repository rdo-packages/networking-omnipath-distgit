...
BuildRequires: python%{pyver}-devel
BuildRequires: hacking!=0.13.0,<0.14,>=0.12.0
BuildRequires: coverage!=4.4,>=4.0
BuildRequires: flake8-import-order==0.12
BuildRequires: python-subunit>=1.0.0
BuildRequires: sphinx!=1.6.6,!=1.6.7,>=1.6.2
BuildRequires: openstackdocstheme>=1.18.1
BuildRequires: doc8>=0.6.0
BuildRequires: oslotest>=3.2.0
BuildRequires: os-testr>=1.0.0
BuildRequires: pylint==1.9.3;python_version<'3.0'
BuildRequires: pylint==2.3.0;python_version>='3.0'
BuildRequires: testresources>=2.0.0
BuildRequires: testscenarios>=0.4
BuildRequires: WebTest>=2.0.27
BuildRequires: testtools>=2.2.0
BuildRequires: reno>=2.5.0
